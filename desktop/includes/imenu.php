...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user animated flipInY">
        <li><a href="consultas.php"><i class="ti-flag-alt"></i> Consultas</a></li>
        <li><a href="pacientes.php"><i class="ti-flag-alt"></i> Pacientes</a></li>
        <li><a href="nueva_consulta.php"><i class="ti-medall-alt"></i> Nueva Consulta</a></li>
        <li><a href="nueva_paciente.php"><i class="ti-medall-alt"></i> Nueva Paciente</a></li>
    </ul>
    <!-- /.dropdown-messages -->
</li>
<!-- /.dropdown -->

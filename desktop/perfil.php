                    ...
                    <div class="white-box">
                        <div class="user-bg"> <img width="100%" alt="user" src="../<?php echo $obj->cphoto2; ?>">
                            <div class="overlay-box">
                                <div class="user-content"> <a href="javascript:void(0)"><img src="../<?php echo $obj->cphoto1; ?>" class="thumb-lg img-circle" alt="img"></a>
                                    <h4 style="text-shadow: 2px 1px #FFFFFF;"><?php echo $obj->cname; ?></h4>
                                    <h5 style="text-shadow: 2px 1px #FFFFFF;"><?php echo $obj->cuser; ?></h5>
                                </div>
                            </div>
                        </div>
                        <div class="user-btm-box">
                            <div class="col-md-4 col-sm-4 text-center">
                                ...
                                <p><a href="https://www.facebook.com/<?php echo $obj->cfb; ?>"> <?php echo $obj->cfb; ?></a></p>
                            </div>
                            <div class="col-md-4 col-sm-4 text-center">
                                <p class="text-blue"><i class="ti-twitter"></i></p>
                                <p><a href="https://twitter.com/<?php echo $obj->ctw; ?>"><?php echo $obj->ctw; ?></a></p>
                            </div>
                            <div class="col-md-4 col-sm-4 text-center">
                                <p class="text-danger"><i class="ti-instagram"></i></p>
                                <p><a href="https://www.instagram.com/<?php echo $obj->cins; ?>"><?php echo $obj->cins; ?></a></p>
                            </div>
                        </div>
                    </div>
                </div>

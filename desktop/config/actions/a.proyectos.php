...
class A_PRO
{
     ...
     * @return mixed
     */
    public function ins_datosCompetencia($DBcon, $idProyecto, $competidor, $dif, $propuesta, $valor)
    {
        $now = date("Y-m-d H:i:s");

        $query = "INSERT INTO  tp_competencia
                    (idproyecto,cp_competidor, cp_diferenciador, cp_propuestav, cp_valor) 
					VALUES
					('".$idProyecto."','".$competidor."','".$dif."','".$propuesta."','".$valor."')";
     ...
     * @return mixed
     */
    public function ins_datosMercado($DBcon, $idProyecto, $cliente, $segmento, $mercado, $marketing, $ventas, $precio, $dif, $canal, $valor, $market)
    {
        $now = date("Y-m-d H:i:s");

        $query = "INSERT INTO  tp_mercado
                    (idproyecto,cp_cliente, cp_segmento, cp_mercado, cp_marketing, cp_ventastot, cp_precio, cp_diferenciador, cp_canaldist, cp_valormercado, cp_marketshare) 
					VALUES
					('".$idProyecto."','".$cliente."','".$segmento."','".$mercado."','".$marketing."','".$ventas."','".$precio."','".$dif."','".$canal."','".$valor."','".$market."')";
     ...
     * @return mixed
     */
    public function ins_datosHistoria($DBcon, $idProyecto, $descripcion, $fechaa)
    {

        $query = "INSERT INTO  tp_historia
                    (idproyecto,cp_desc, cp_fecha) 
					VALUES
					('".$idProyecto."','".$descripcion."','".$fechaa."')";
     ...
     * @return mixed
     */
    public function ins_datosEquipo($DBcon, $idProyecto, $nombre, $puesto, $desc)
    {

        $query = "INSERT INTO  tp_equipo
                    (idproyecto,cp_nombre, cp_puesto, cp_desc ) 
					VALUES
					('".$idProyecto."','".$nombre."','".$puesto."','".$desc."')";
    ...
    {
        $sql= "SELECT cp_competidor AS Competidor, cp_diferenciador AS Diferenciador, cp_propuestav AS Propuesta, cp_valor AS Valor FROM tp_competencia WHERE idProyecto = '".$id."'";
    ...
    {
        $sql= "SELECT cp_cliente AS Cliente, cp_segmento AS Segmento, cp_mercado AS Mercado, cp_marketing as Marketing, cp_ventastot AS Ventas, cp_precio AS Precio, cp_diferenciador AS Diferenciador, cp_canaldist AS Canales, cp_valormercado AS Valor, cp_marketshare AS MarketShare
    ...
    {
        $sql= "SELECT cp_desc AS Descripcion, cp_fecha AS Fecha
    ...
    {
        $sql= "SELECT cp_nombre AS Nombre, cp_puesto AS Puesto, cp_desc AS Descripcion 
     ...
     */
    public function upd_inversion($DBcon, $idProyecto, $monto, $fin, $startup, $duracion, $aniosop )
    {
        $query = "UPDATE ".$this->tableName." SET 
                 cmetamin  = '".$monto."',
                  cfinrecursos  = '".$fin."',
     ...
     */
    function upd_ideaproyecto($DBcon, $idProyecto, $problema, $solucion, $plan, $resultados, $oportunidad, $estrategia, $objetivos)
    {
        $query = "UPDATE tproyectos SET 
              ...
              coportunidad = '".$oportunidad."',
              cobjetivos2 = '".$estrategia."',
              cestrategia2 = '".$objetivos."'
                    WHERE id  = '".$idProyecto."' 
					";
